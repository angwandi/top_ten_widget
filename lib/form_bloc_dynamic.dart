...
class FormBlocDynamicScreen extends StatefulWidget {
  static const String id = 'form_block_dyanamic';
  @override
  _FormBlocDynamicScreenState createState() => _FormBlocDynamicScreenState();
}

class _FormBlocDynamicScreenState extends State<FormBlocDynamicScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Form Bloc Dynamic"),
      ),
      body: ListFieldsForm(),
    );
  }
